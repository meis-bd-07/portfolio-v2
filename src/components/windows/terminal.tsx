import { TERMINAL_CONS } from "@constants";
    ...
    return (
        <>
            ...
            <div className="techstack">
                <p>
                    <span className="font-bold">@erfan % </span>
                    show tech stack
                </p>
                <div className="label">
                ...
                <ul className="content content-alt scrollbar-custom">
                    {TERMINAL_CONS.techStack.map(({category, items}) => (
